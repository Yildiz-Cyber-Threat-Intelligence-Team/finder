...
func printUsage() {
	fmt.Println("Kullanım: go run main.go \"arsiv_dosya_yolu\" \"arama_metni\" \"dosya_turu\" [cikti_dosyasi]")
	fmt.Println("Örnek: go run main.go \"dosya.rar\" \"searchWord\" \".rar\" [output.txt]")
}
